...
<form action="{{route('userstory.update', $userstory)}}" method="post" >
    ...
    User Story :<input type="text" name="user_story" style="margin-left:2.5em" readonly value="{{$userstory->user_story}}">
    <br><br><br>

    Description :<input type="text" name="desc_story" style="margin-left:2.6em" value="{{$userstory->desc_story}}">
