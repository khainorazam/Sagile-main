...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            ...
            <form method="post" action="<?php echo e(route('project.store')); ?>" autocomplete="off">
                <div class="card-body">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', ['page' => __('Icons'), 'pageSlug' => 'icons'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\SAgile\resources\views/project/create.blade.php ENDPATH**/ ?>